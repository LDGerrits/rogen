...
Rogen merges multiple source directories into a single Rojo project. This feature allows developers to share core code across places without duplicating logic.
...
<Callout type="info">
	...
	listed last in the `source` array overwrites previous files. This can be a
	powerful feature.
</Callout>

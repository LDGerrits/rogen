...
describe("Builder Integration", () => {
	...
	it("should create empty folders for directories containing .gitkeep or .keep files", async () => {
		...
		expect(
			resultTree.ReplicatedStorage.shared.EmptyFeatureA.$className
		).toBe("Folder");
		expect(
			resultTree.ReplicatedStorage.shared.EmptyFeatureA.$path
		).toBeUndefined();

		expect(resultTree.ReplicatedStorage.shared.EmptyFeatureB).toBeDefined();
		expect(
			resultTree.ReplicatedStorage.shared.EmptyFeatureB.$className
		).toBe("Folder");
		expect(
			resultTree.ReplicatedStorage.shared.EmptyFeatureB.$path
		).toBeUndefined();

		expect(
			resultTree.ReplicatedStorage.shared.IgnoredFeatureC
		).toBeUndefined();
	});
